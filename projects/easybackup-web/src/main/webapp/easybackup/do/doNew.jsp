...
if(names.contains(type.toUpperCase()+":"+name)){
	session.setAttribute("MSG", resourceBundle.getString("new.exists"));
	response.sendRedirect(basePath+"easybackup/do/toGlobal.jsp");
	return;
}
...
map.put("n1", "#newLine");
map.put("n2", "#newLine");
map.put("===="+name+":"+type+" backup [Auto generator by EasyBackup Web] ====#","#comments");
