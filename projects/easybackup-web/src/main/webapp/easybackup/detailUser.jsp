...
<div class="form-group">
	...
	<%=resourceBundle.getString("conf.file") %></p>
	</div>
</div>
...
<div class="form-group">
	...
	<div class="col-sm-6">
	  <input name="targetFileClass" value="${fn:escapeXml(conf.targetFileClass)}" type="text"  class="form-control" id="inputtargetFileClass" placeholder="custome target file source class">
	</div>
	<div class="col-sm-4 text-info"> 
...
<div class="form-group">
	...
	<div class="col-sm-6">
	  <input name="dirClass" value="${fn:escapeXml(conf.dirClass)}"  type="text" class="form-control" id="inputDirClass" placeholder="custome backup directory class">
	</div>
	<div class="col-sm-4 text-info"> 
...
<div class="form-group">
	...
	<div class="col-sm-6">
	  <input name="fileClass" value="${fn:escapeXml(conf.fileClass)}" type="text"  class="form-control" id="inputFileClass" placeholder="custome backup file name class">
	</div>
	<div class="col-sm-4 text-info"> 
...
<div class="form-group">
	...
	<div class="col-sm-6">
	  <input name="backupClass" value="${fn:escapeXml(conf.backupClass)}" type="text"  class="form-control" id="inputBackupClass" placeholder="custome backup implement class">
	</div>
	<div class="col-sm-4 text-info"> 
...
<div class="form-group">
	...
	<div class="col-sm-4 text-info"><p class="">
	<%=resourceBundle.getString("conf.title") %></p></div>
</div>
...
<div class="form-group">
	...
	<div class="col-sm-4 text-info"> <p class="">
	<%=resourceBundle.getString("conf.cmdBefore") %></p></div>
</div>
...
<div class="form-group">
	...
	<div class="col-sm-4 text-info"> <p class="">
	<%=resourceBundle.getString("conf.beforeClass") %></p>
		</div>
</div>
