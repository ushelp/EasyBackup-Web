...
<head>
	...
	<base href="<%=basePath%>">
	<title><%=resourceBundle.getString("configurations_errors.h1") %> - EasyBackup Web Management System</title>
...
<body>
 <%
   ...
   List<BackupConfiguration> backupConfigs=BackupRuntime.errorJobBackupsOnStartup;
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			...
			<%=resourceBundle.getString("configurations_errors.h1") %>
			</h1>
            <div class="panel panel-default">
  <!-- Default panel contents -->
  <div class="panel-heading"><%=resourceBundle.getString("configurations_errors.table.header") %></div>
...
<script type="text/javascript">
	...
	function sort(s){
		...
		window.location.href='easybackup/configuraions_errors.jsp?s='+nowSort+'&o='+nowOrder;
	}
</script>
